...
\subsection{Program 1 - Hello World}
    \begin{itemize}
        ...
        \item Wnioski - Program w początkowych fazach rozwoju projektu, służył głównie do rozpoznania czy nasz "pendrive" po podpięciu go do portu USB wykrywany jest poprawnie oraz czy działa według naszych założen. Na większość napotkanych problemów (Rodział 7.3), z którymi zderzyliśmy się podczas tworzenia projektu natrafiliśmy podczas testów na tym programie. Pozowlił nam on na dopracowanie działania naszego urządzenia oraz rozwiązaniu błędów związanych z jego działaniem.    
    \end{itemize}
